...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Welcome To Amar Doctor Dashboard</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        ...
                                                        <span
                                                            class="contacts-list-msg">How have you been? I was...
                                                            </span>
                                                    </div>
                                                    <!-- /.contacts-list-info -->
                                                </a>
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        ...
                                                        <span
                                                            class="contacts-list-msg">I will be waiting for...
                                                            </span>
                                                    </div>
                                                    <!-- /.contacts-list-info -->
                                                </a>
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        ...
                                                        <span
                                                            class="contacts-list-msg">I'll call you back at...
                                                            </span>
                                                    </div>
                                                    <!-- /.contacts-list-info -->
                                                </a>
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        ...
                                                        <span
                                                            class="contacts-list-msg">Can I take a look at...
                                                            </span>
                                                    </div>
                                                    <!-- /.contacts-list-info -->
                                                </a>
